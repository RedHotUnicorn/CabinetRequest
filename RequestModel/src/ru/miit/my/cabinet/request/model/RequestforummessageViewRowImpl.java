...
public class RequestforummessageViewRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        SomeAttr {
            public Object get(RequestforummessageViewRowImpl obj) {
                return obj.getSomeAttr();
            }

            public void put(RequestforummessageViewRowImpl obj, Object value) {
                obj.setSomeAttr((String)value);
            }
        }
        ,
    ...
    public static final int SOMEATTR = AttributesEnum.SomeAttr.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute SomeAttr.
     * @return the SomeAttr
     */
    public String getSomeAttr() {
        ...
        System.out.println();
        System.out.println();
        return "hello";// (String) getAttributeInternal(SOMEATTR);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute SomeAttr.
     * @param value value to set the  SomeAttr
     */
    public void setSomeAttr(String value) {
        setAttributeInternal(SOMEATTR, value);
    }
